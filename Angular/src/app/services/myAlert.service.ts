//import { AlertDialogComponent,AlertDialogRef } from './../components/dialogs/alert-dialog/alert-dialog.component';
...
export class MyAlertService {
  ...
  AlertUygula(s:Sonuc){
    ...
    this.AlertDialogRef=this.matDialog.open(AlertDialogComponent, {width:'300px'});
